 ...
 * @author Rosemary
 */
public class PeminjamEditMember extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                <div class=\"row\">\n"
                        + "                    <div class=\"col-xs-12\">\n"
                        + "                        <form method=\"post\" name=\"myform\" action=\"../PeminjamEditMemberSimpan\">\n"
                        ...
                        + "                                                        <button type=\"submit\" class=\"btn btn-default\" id=\"deselect\" name=\"deselect_x\" value=\"1\" onclick=\"$j('form').eq(0).attr('novalidate', 'novalidate'); document.myform.reset(); return true;\" title=\"Back\">\n"
                        + "                                                            <i class=\"glyphicon glyphicon-chevron-left\"></i> Reset</button>\n"
                        + "                                                    </div>\n"
                        + "                                                    <p></p>\n"
                        + "                                                    <div class=\"btn-group-vertical btn-group-lg\" style=\"width: 100%;\">\n"
                        + "                                                        <button type=\"submit\" class=\"btn btn-success\" id=\"insert\" name=\"insert_x\" value=\"1\" onclick=\"return Users_validateData();\"><i class=\"glyphicon glyphicon-plus-sign\"></i> Simpan</button>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                            </div>\n"
                        + "                                        </div>\n"
