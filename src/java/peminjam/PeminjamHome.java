 ...
 * @author Rosemary
 */
public class PeminjamHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                query = "select count(idpeminjaman) from peminjaman where idpeminjam = '" + iduser + "'";
                ...
                query = "select count(idpemesanan) from pemesanan where idpeminjam   = '" + iduser + "'";;
                statement = conn.getConnection().createStatement();
                result = statement.executeQuery(query);
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                <h1>Peminjam<small>Control panel</small></h1>\n"
                        + "                <ol class=\"breadcrumb\">\n"
