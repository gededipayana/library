 ...
 * @author Rosemary
 */
public class PeminjamLihatTransaksi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                String query2 = "select * from peminjaman where idpeminjam = '" + iduser + "'";
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                                                <input type=\"text\" id=\"SearchString\" name=\"katakuncipemesanan\" value=\"\" class=\"form-control\" placeholder=\"Cari\">\n"
                ...
                out.println("                                                </tbody>\n"
                        ...
                        + "                                        </div>\n"
                        + "                                        <form method=\"post\" action=\"./lihattransaksi\">\n"
                        + "                                            <div class=\"col-sm-5\">		\n"
                        + "                                                <div class=\"input-group\" id=\"quick-search\">\n"
                        + "                                                    <input type=\"text\" id=\"SearchString\" name=\"katakuncipeminjaman\" value=\"\" class=\"form-control\" placeholder=\"Cari\">\n"
                        + "                                                    <span class=\"input-group-btn\">\n"
                        + "                                                        <button name=\"Search_x\" value=\"1\" id=\"Search\" type=\"submit\" onClick=\"#\" class=\"btn btn-default\" title=\"Quick Search\"><i class=\"glyphicon glyphicon-search\"></i></button>\n"
                        + "                                                    </span>\n"
                        + "                                                </div>			\n"
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                if (request.getParameter("katakuncipemesanan") != null) {
                    ...
                    query = "select * from pemesanan where idpemesanan like '%" + kataKunciPemesanan + "%' and idpeminjam = '" + iduser + "'";
                } else {
                    query = "select * from pemesanan where idpeminjam = '" + iduser + "'";
                }
                ...
                if (request.getParameter("katakuncipeminjaman") != null) {
                    ...
                    query2 = "select * from peminjaman where idpeminjam = '" + iduser + "'";
                }
