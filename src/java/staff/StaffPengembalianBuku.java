 ...
 * @author Rosemary
 */
public class StaffPengembalianBuku extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                                                    <input type=\"text\" id=\"SearchString\" name=\"katakunci\" value=\"\" class=\"form-control\" placeholder=\"Cari ID Pemimjaman\">\n"
                        ...
                        + "                                </div>\n"
                        + "                                <span><br></span>\n"
                        + "                                <form method=\"post\" action=\"../StaffPengembalianBuku\">\n"
                        + "                                    <div class=\"col-sm-12\">		\n"
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                                </div>\n"
                        + "                                <span><br></span>\n"
                        + "                                <form method=\"post\" action=\"../StaffPengembalianBukuSimpan\">\n"
                        + "                                    <div class=\"col-sm-12\">		\n"
                        + "                                        <div class=\"col-xs-12 detail_view \">\n"
                        + "                                            <div class=\"panel panel-default\">\n"
                        + "                                                <a name=\"detail-view\"></a>\n"
