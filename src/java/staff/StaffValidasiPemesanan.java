 ...
 * @author Rosemary
 */
public class StaffValidasiPemesanan extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "							</div>\n"
                        + "							<span><br></span>\n"
                        + "						<form method=\"post\" action=\"../StaffValidasiPemesananSimpan\">\n"
                        + "						<div class=\"col-sm-12\">		\n"
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                if (!idPeminjam.equals("")) {
                    ...
                    String query2 = "select * from pemesanan where idpemesanan = '" + katakunci + "'";
