 ...
 * @author Rosemary
 */
public class AdminLihatBuku extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                <ol class=\"breadcrumb\">\n"
                        + "                    <li><a href=\"admin.html\"><i class=\"fa fa-dashboard\"></i>Admin</a></li>\n"
                        + "                    <li class=\"active\">lihatbuku</li>\n"
                        + "                </ol>\n"
                        + "            </section>\n"
                        + "			<!-- Scroll -->\n"
                        ...
                        + "            <div class=\"row\">\n"
                        + "                <div class=\"col-xs-12\">\n"
                        + "                    <form method=\"post\" name=\"myform\" action=\"./lihatbuku.html\">\n"
                        + "                        <input id=\"EnterAction\" type=\"submit\" style=\"position: absolute; left: 0px; top: -250px;\" onclick=\"return enterAction();\">\n"
                        + "                        <div class=\"page-header\">\n"
                        + "                            <h1>\n"
                        + "							<div class=\"row\"><div class=\"col-sm-8\"><a style=\"text-decoration: none; color: inherit;\" href=\"admin.html\">\n"
                        + "							<img src=\"../resources/table_icons/books.png\"> Buku</a></div>\n"
                        + "							<div class=\"col-sm-4\">		\n"
                        + "								<div class=\"input-group\" id=\"quick-search\">\n"
                        + "									<input type=\"text\" id=\"SearchString\" name=\"katakunci\" value=\"\" class=\"form-control\" placeholder=\"Cari ID Buku / Judul Buku\">\n"
                        ...
                        + "                                <button type=\"submit\" class=\"btn btn-success\"><i class=\"glyphicon glyphicon-plus-sign\"></i><a href=\"tambahbuku.html\"> Tambah Buku</a></button>\n"
                        + "                                <button type=\"submit\" class=\"btn btn-success\"><i class=\"glyphicon glyphicon-check\"></i><a href=\"editbuku.html\"> Edit Buku</a></button>\n"
                        + "                            </div>\n"
                        + "                            <div class=\"row\">\n"
                        + "							\n"
