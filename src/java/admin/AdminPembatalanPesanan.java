 ...
 * @author Rosemary
 */
public class AdminPembatalanPesanan extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "										<input type=\"text\" id=\"SearchString\" name=\"katakunci\" value=\"\" class=\"form-control\" placeholder=\"Cari\">\n"
                        ...
                        + "							</div>\n"
                        + "							<span><br></span>\n"
                        + "							<form method=\"post\" action=\"../AdminPembatalanPesananSimpan\">\n"
                        + "						<div class=\"col-sm-12\">		\n"
