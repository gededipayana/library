 ...
 * @author Rosemary
 */
public class AdminPeminjamanLangsung extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                                            <div class=\"col-sm-8\">\n"
                        + "                                                <br><h3>ID Peminjam</h3>\n"
                        + "                                            </div>\n"
                        + "                                            <div class=\"col-sm-5\">		\n"
                        + "                                                <div class=\"input-group\" id=\"quick-search\">\n"
                        + "                                                    <input type=\"text\" id=\"SearchString\" name=\"katakuncipeminjam\" value=\"\" class=\"form-control\" placeholder=\"Cari ID Peminjam\">\n"
                        ...
                        + "                                            <div class=\"col-sm-5\">		\n"
                        + "                                                <div class=\"input-group\" id=\"quick-search\">\n"
                        + "                                                    <input type=\"text\" id=\"SearchString\" name=\"katakuncibuku\" value=\"\" class=\"form-control\" placeholder=\"Cari ID Buku\">\n"
                        + "                                                    <span class=\"input-group-btn\">\n"
                        + "                                                        <button name=\"Search_x\" value=\"1\" id=\"Search\" type=\"submit\" onClick=\"#\" class=\"btn btn-default\" title=\"Cari\"><i class=\"glyphicon glyphicon-search\"></i></button>\n"
                        + "                                                    </span>\n"
                        + "                                                </div>			\n"
                        ...
                        + "                                </div>\n"
                        + "                                <span><br></span>\n"
                        + "                                <form method=\"post\" name=\"myform\" action=\"../AdminPeminjamanLangsungSimpan\">"
                        + "                                <div class=\"col-sm-12\">		\n"
                        ...
                        + "                                                                <label for=\"Membership_Number\" class=\"control-label col-lg-3\">ID Peminjam</label>\n"
                        + "                                                                <div class=\"col-lg-9\">\n"
