 ...
 * @author Rosemary
 */
public class AdminTambahBuku extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                <div class=\"row\">\n"
                        + "                    <div class=\"col-xs-12\">\n"
                        + "                        <form method=\"post\" name=\"myform\" action=\"./tambahbuku.html\">\n"
                        + "                            <div class=\"page-header\">\n"
                        + "                                <h1><a style=\"text-decoration: none; color: inherit;\" href=\"tambahmember.html\"><img src=\"../resources/table_icons/books.png\"> Tambah Buku</a></h1>\n"
                        + "                            </div>\n"
                        ...
                        + "                                                        <div class=\"col-lg-9\">\n"
                        + "                                                            <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"idbuku\" id=\"Membership_Number\" value=\"\">\n"
                        + "                                                        </div>\n"
                        + "                                                    </div>\n"
                        + "                                                    <div class=\"form-group\">\n"
                        + "                                                        <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                        <button type=\"reset\" class=\"btn btn-default\" id=\"deselect\" name=\"deselect_x\" value=\"1\" title=\"Bersihkan\">\n"
                        + "                                                            <i class=\"glyphicon glyphicon-chevron-left\"></i> Bersihkan</button>\n"
                        + "                                                    </div>\n"
                        + "                                                    <p></p>\n"
                        + "                                                    <div class=\"btn-group-vertical btn-group-lg\" style=\"width: 100%;\">\n"
                        + "                                                        <button type=\"submit\" class=\"btn btn-success\" id=\"insert\" name=\"insert_x\" value=\"1\" onclick=\"return confirm('Apakah kamu yakin ingin menambahkan data ini?');\"><i class=\"glyphicon glyphicon-plus-sign\"></i> Simpan</button>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                            </div>\n"
                        + "                                        </div>\n"
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                String idbuku = request.getParameter("idbuku").toUpperCase();
                String judulbuku = request.getParameter("judulbuku").toUpperCase();
                String penerbit = request.getParameter("penerbit").toUpperCase();
                String pengarang = request.getParameter("pengarang").toUpperCase();
                String tahunterbit = request.getParameter("tahunterbit").toUpperCase();
                String kategori = request.getParameter("kategori").toUpperCase();

                //apabila salah satu tidak terisi
                if (idbuku.equals("") || judulbuku.equals("") || penerbit.equals("") || pengarang.equals("") || tahunterbit.equals("") || kategori.equals("")) {
                    response.sendRedirect("./tambahbuku.html");
                    ...
                    if (found.equals("")) { //buat member jika belum ada
                        String query2 = "insert into buku values ('" + idbuku + "', '" + kategori + "', '" + judulbuku +  "', '" + penerbit + "', '" 
                                + tahunterbit + "', '" + pengarang + "', 'TERSEDIA')";
                        Statement statement2 = conn.getConnection().createStatement();
                        statement2.executeUpdate(query2);
                        response.sendRedirect("./lihatbuku.html");
                        statement2.close();
                    } else { //jika idbuku ditemukan sama di dalam database
                        ...
                        + "                                    <a name=\"detail-view\"></a>\n"
                        + "                                    <div class=\"panel-heading\">\n"
                        + "                                        <h3 class=\"panel-title\"><strong>Detail Buku - </strong><font color=\"red\">Buku sudah terdaftar</font></h3></div>\n"
                        + "                                    <div class=\"panel-body\" id=\"Users_dv_container\">\n"
                        + "                                        <div class=\"row\">\n"
                        + "                                            <div class=\"col-md-8 col-lg-10\" id=\"Users_dv_form\">\n"
                        + "                                                <fieldset class=\"form-horizontal\">\n"
                        ...
                        + "                                                        <label for=\"Membership_Number\" class=\"control-label col-lg-3\">ID Buku</label>\n"
                        + "                                                        <div class=\"col-lg-9\">\n"
                        + "                                                            <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"idbuku\" id=\"Membership_Number\" value=\"" + idbuku + "\">\n"
                        + "                                                        </div>\n"
                        + "                                                    </div>\n"
                        + "                                                    <div class=\"form-group\">\n"
                        + "                                                        <hr class=\"hidden-md hidden-lg\">\n"
