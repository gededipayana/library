 ...
 * @author Rosemary
 */
public class AdminHapusMember extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                    <li class=\"active\">hapusmember</li>\n"
                        + "                </ol>\n"
                        + "            </section>\n"
                        + "			<!-- Scroll -->\n"
                        ...
                        + "                            <h1><a style=\"text-decoration: none; color: inherit;\" href=\"hapusmember.html\"><img src=\"../resources/table_icons/group.png\"> Hapus Member</a></h1>\n"
                        + "						</div>\n"
                        + "						<form method=\"post\" action=\"./hapusmember.html\">\n"
                        + "						<h1>\n"
                        + "							<div class=\"row\">\n"
                        + "								<div class=\"col-sm-8\">\n"
                        + "									<h3>   Cari</h3>\n"
                        ...
                        + "										<input type=\"text\" id=\"SearchString\" name=\"katakunci\" value=\"\" class=\"form-control\" placeholder=\"Cari ID Member\">\n"
                        ...
                        + "							</div>\n"
                        + "						</form>\n"
                        + "						<form method=\"post\" name=\"myform\" action=\"../AdminHapusMemberSimpan\">\n"
                        + "                        <div class=\"col-xs-12 detail_view\">\n"
                        + "                            <div class=\"panel panel-default\">\n"
                        + "                                <a name=\"detail-view\"></a>\n"
                        + "                                <div class=\"panel-heading\">\n"
                        + "                                    <h3 class=\"panel-title\"><strong>Member details</strong></h3></div>\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"iduser\" id=\"Membership_Number\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "												<div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"username\" id=\"Username\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "												<div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"password\" id=\"Password\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"nama\" id=\"Name\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"alamat\" id=\"Contact\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"email\" id=\"Contact\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"notelp\" id=\"Contact\" value=\"\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                            </fieldset>\n"
                        + "                                        </div>\n"
                        ...
                        + "                                                    <button type=\"submit\" class=\"btn btn-danger\" id=\"delete\" name=\"delete_x\" value=\"1\" onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?');\" title=\"Delete\">\n"
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                String iduser = request.getParameter("katakunci");
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "								<div class=\"col-sm-5\">		\n"
                        + "									<div class=\"input-group\" id=\"quick-search\">\n"
                        + "										<input type=\"text\" id=\"SearchString\" name=\"katakunci\" value=\"\" class=\"form-control\" placeholder=\"Cari ID User\">\n"
                        + "											<span class=\"input-group-btn\">\n"
                        + "												<button name=\"Search_x\" value=\"1\" id=\"Search\" type=\"submit\" onClick=\"#\" class=\"btn btn-default\" title=\"Cari\"><i class=\"glyphicon glyphicon-search\"></i></button>\n"
                        + "											</span>\n"
                        + "									</div>			\n"
                        ...
                        + "                                                    <label for=\"Name\" class=\"control-label col-lg-3\">Username</label>\n"
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"username\" id=\"Username\" value=\"" + username + "\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "												<div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        + "                                                    <label for=\"Name\" class=\"control-label col-lg-3\">Password</label>\n"
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"password\" id=\"Password\" value=\"" + pass + "\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        + "                                                    <label for=\"Name\" class=\"control-label col-lg-3\">Nama</label>\n"
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"nama\" id=\"Name\" value=\"" + nama + "\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        + "                                                    <label for=\"Contact\" class=\"control-label col-lg-3\">Alamat</label>\n"
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"alamat\" id=\"Contact\" value=\"" + alamat + "\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        + "                                                    <label for=\"Contact\" class=\"control-label col-lg-3\">Email</label>\n"
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"email\" id=\"Contact\" value=\"" + email + "\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        + "                                                    <label for=\"Contact\" class=\"control-label col-lg-3\">No Telp</label>\n"
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"40\" type=\"text\" class=\"form-control\" name=\"notelp\" id=\"Contact\" value=\"" + notelp + "\" readonly>\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                            </fieldset>\n"
                        + "                                        </div>\n"
