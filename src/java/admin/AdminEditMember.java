 ...
 * @author Rosemary
 */
public class AdminEditMember extends HttpServlet {
        ...
        try {
            ...
            if (session.getAttribute("status") == null) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                        </div>\n"
                        + "						<form method=\"post\" action=\"./editmember.html\">\n"
                        + "						<h1>\n"
                        + "							<div class=\"row\">\n"
                        + "								<div class=\"col-sm-8\">\n"
                        + "									<h3>   Cari</h3>\n"
                        ...
                        + "							</div>\n"
                        + "						</form>\n"
                        + "						<form method=\"post\" name=\"myform\" action=\"../AdminEditMemberSimpan\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"username\" id=\"Username\" value=\"\">\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "												<div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
                        ...
                        + "                                                    <div class=\"col-lg-9\">\n"
                        + "                                                        <input maxlength=\"140\" type=\"text\" class=\"form-control\" name=\"password\" id=\"Password\" value=\"\">\n"
                        + "                                                    </div>\n"
                        + "                                                </div>\n"
                        + "                                                <div class=\"form-group\">\n"
                        + "                                                    <hr class=\"hidden-md hidden-lg\">\n"
